...
function adaptor(params) {
    ...
    return utils_1.flow(geometry, meta, common_1.theme, coord, axis, legend, common_1.tooltip, label, common_1.interaction, common_1.animation, common_1.annotation())(params);
}
