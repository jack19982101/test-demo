...
exports.processImageMask = exports.transform = void 0;
...
function getSize(params) {
    ...
    if (autoFit) {
        var containerSize = utils_1.getContainerSize(chart.ele);
 ...
 * @param callback
 */
function processImageMask(img, callback) {
...
function resolveRotate(options) {
    ...
    if (!util_1.isArray(rotation)) {
        utils_1.log(utils_1.LEVEL.WARN, false, 'the rotation option must be an Array in wordStyle option.');
        rotation = [0, 90];
    }
    if (rotationSteps === 0) {
    ...
    if (rotateRatio < 0) {
        utils_1.log(utils_1.LEVEL.WARN, false, 'the rotateRatio option must be greater than or equal to 0 and less than or equal to 1.');
        rotateRatio = 0;
    }
    if (rotateRatio > 1) {
        utils_1.log(utils_1.LEVEL.WARN, false, 'the rotateRatio option must be greater than or equal to 0 and less than or equal to 1.');
