    ...
    var t = util_1.deepMix({}, params, {
        options: {
            ...
            point: {
                ...
                size: util_1.isNumber(size === null || size === void 0 ? void 0 : size.target) ? Number(size.target) / 2 : size.target,
...
function meta(params) {
    ...
    if (meta) {
        var scales = util_1.deepMix({}, meta, (_a = {},
