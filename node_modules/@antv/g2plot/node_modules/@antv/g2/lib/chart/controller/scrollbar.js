...
var Scrollbar = /** @class */ (function (_super) {
    ...
    Scrollbar.prototype.changeViewData = function (_a, render) {
        ...
        var groupedData = util_1.groupBy(this.data, this.xScaleCfg.field);
        var xValues = isHorizontal ? util_1.keys(groupedData) : util_1.keys(groupedData).reverse();
    ...
    Scrollbar.prototype.getCnt = function () {
        ...
        var groupedData = util_1.groupBy(data, xScale.field);
        return util_1.size(util_1.keys(groupedData));
    };
