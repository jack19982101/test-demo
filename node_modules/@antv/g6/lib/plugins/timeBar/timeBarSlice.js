...
function () {
  function TimeBarSlice(cfgs) {
    ...
    var graph = cfgs.graph,
        ...
        _a = cfgs.selectedTickStyle,
        selectedTickStyle = _a === void 0 ? DEFAULT_SELECTEDTICK_STYLE : _a,
        _b = cfgs.unselectedTickStyle,
        unselectedTickStyle = _b === void 0 ? DEFAULT_UNSELECTEDTICK_STYLE : _b,
